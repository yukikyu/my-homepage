...
![](\img\秒杀（高并发）系统关注的问题 - 1.png)

![](\img\秒杀（高并发）系统关注的问题 - 2.png)
...
- sentinel流控界面
  ...
  <img src="\img\gateway-sentinel流控界面.png"  />

  - 针对请求属性

    ![](\img\gateway-sentinel流控界面 - 针对请求属性.png)

  - api分组

    ![](\img\gateway-sentinel流控界面 - api分组.png)
