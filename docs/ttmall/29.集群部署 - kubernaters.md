...
![](\img\datahub\components-of-kubernetes.svg)

### 整体主从方式

![](\img\datahub\Kubernetes cluster.png)
...
- Volume
  ...
  - 支持多种后端存储抽象（本地存储，分布式存储，云存储。。。）
    ...
    ![](\img\datahub\KuBernetes概念 - 01.png)
...
- Deployment：
  ...
  - 通过控制器以指定的策略控制版本（滚动升级，回滚等）
    ...
    ![](\img\datahub\KuBernetes概念 - 02.png)
...
- Service
  ...
  - Pod的负载均衡，提供一个或者多个Pod的稳定访问地址
    ...
    ![](\img\datahub\KuBernetes概念 - 03.png)

  - 支持多种方式（ClusterIP、NodePort、Loadalance）

- Lable：标签，用于对象资源的查询，筛选

  ![](\img\datahub\KuBernetes概念 - 04.png)
...
>
> ![](\img\datahub\KuBernetes概念 - yaml.png)
...
![](\img\datahub\kuberbetes部署步骤.png)
