...
![](\img\datahub\Kubesphere-部署应用.png)
...
- mysql部署分析
  ...
  ![](\img\datahub\Kubesphere-mysql部署分析.png)

  > 1. 创建配置文件
  > 2. 创建pvc（数据挂载卷）
  > 3. 创建有状态集

  ![](\img\datahub\Kubesphere-mysql部署-01.png)

  ![Kubesphere-mysql部署-02](\img\datahub\Kubesphere-mysql部署-02.png)

  ![Kubesphere-mysql部署-03](\img\datahub\Kubesphere-mysql部署-03.png)

  ![](\img\datahub\Kubesphere-mysql部署-04.png)

  ![Kubesphere-mysql部署-05](\img\datahub\Kubesphere-mysql部署-05.png)
